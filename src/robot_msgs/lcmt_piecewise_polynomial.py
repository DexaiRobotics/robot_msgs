...
import robot_msgs.lcmt_polynomial_matrix

class lcmt_piecewise_polynomial(object):
    __slots__ = ["timestamp", "num_breaks", "breaks", "num_segments", "polynomial_matrices"]

    __typenames__ = ["int64_t", "int32_t", "double", "int32_t", "robot_msgs.lcmt_polynomial_matrix"]

    __dimensions__ = [None, None, ["num_breaks"], None, ["num_segments"]]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_segments):
            assert self.polynomial_matrices[i0]._get_packed_fingerprint() == robot_msgs.lcmt_polynomial_matrix._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.polynomial_matrices = []
        for i0 in range(self.num_segments):
            self.polynomial_matrices.append(robot_msgs.lcmt_polynomial_matrix._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6392ab0e78c32254+ robot_msgs.lcmt_polynomial_matrix._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def get_hash(self):
        ...
        return struct.unpack(">Q", lcmt_piecewise_polynomial._get_packed_fingerprint())[0]
