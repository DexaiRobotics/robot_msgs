...
#ifndef __robot_msgs_robot_state_t_hpp__
#define __robot_msgs_robot_state_t_hpp__
...
#include "robot_msgs/twist_t.hpp"
...
uint64_t robot_state_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x10a7718a75ccc314LL +
         robot_msgs::pose_t::_computeHash(&cp) +
         robot_msgs::twist_t::_computeHash(&cp) +
         drake::lcmt_force_torque::_computeHash(&cp);
