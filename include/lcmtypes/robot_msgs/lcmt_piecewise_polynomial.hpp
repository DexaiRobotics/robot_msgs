...
#ifndef __robot_msgs_lcmt_piecewise_polynomial_hpp__
#define __robot_msgs_lcmt_piecewise_polynomial_hpp__
...
class lcmt_piecewise_polynomial
{
    public:
        ...
        std::vector< robot_msgs::lcmt_polynomial_matrix > polynomial_matrices;
...
uint64_t lcmt_piecewise_polynomial::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == lcmt_piecewise_polynomial::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, lcmt_piecewise_polynomial::getHash };

    uint64_t hash = 0x6392ab0e78c32254LL +
         robot_msgs::lcmt_polynomial_matrix::_computeHash(&cp);
