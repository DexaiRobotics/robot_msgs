...
#ifndef __robot_msgs_pose_t_hpp__
#define __robot_msgs_pose_t_hpp__
...
{
    public:
        drake::lcmt_point translation;

        drake::lcmt_quaternion rotation;
...
uint64_t pose_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x1275bd1ccbdaf47fLL +
         ...
         drake::lcmt_quaternion::_computeHash(&cp);
